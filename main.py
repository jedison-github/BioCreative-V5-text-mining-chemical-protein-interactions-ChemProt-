...
W2V_PUBMED_FPATH = (
    'word2vec/pubmed_full_umlsstop_word2vec_model_{}_{}'
).format(W2V_SIZE, W2V_WINDOW)

# Pos2Vec word2vec model filepath (None to use random embeddings)
#P2V_FPATH = None
P2V_FPATH = 'word2vec/pos-size20-window3-iter100.kv'
...
#D2V_FPATH = None
D2V_FPATH = 'word2vec/dep-size20-window3-iter100.kv'
...
EXTERNAL_ZIPS = [
    os.path.join(
        DATA, 'chemprot_{}/support/processed_corpus.zip'.format(group),
